...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#features">PRODUCT</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#details">FEATURES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#details">VIDEO</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#details">TESTIMONI</a>
                    </li>
                </ul>
                <span class="nav-item">
                    <a class="btn-outline-sm" href="<?= base_url('auth/login') ?>">LOG IN</a>
                </span>
            </div>
    ...
    <!-- Scripts -->
    <script src="<?php base_url('assets/') ?>t_2/js/jquery.min.js"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="<?php base_url('assets/') ?>t_2/s/popper.min.js"></script> <!-- Popper tooltip library for Bootstrap -->
    <script src="<?php base_url('assets/') ?>t_2/js/bootstrap.min.js"></script> <!-- Bootstrap framework -->
    <script src="<?php base_url('assets/') ?>t_2/js/jquery.easing.min.js"></script> <!-- jQuery Easing for smooth scrolling between anchors -->
    <script src="<?php base_url('assets/') ?>t_2/js/swiper.min.js"></script> <!-- Swiper for image and text sliders -->
    <script src="<?php base_url('assets/') ?>t_2/js/jquery.magnific-popup.js"></script> <!-- Magnific Popup for lightboxes -->
    <script src="<?php base_url('assets/') ?>t_2/js/validator.min.js"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="<?php base_url('assets/') ?>t_2/js/scripts.js"></script> <!-- Custom scripts -->
