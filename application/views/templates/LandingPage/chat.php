...
<body>
    ...
    <label style="position: fixed" class="chat-btn mb-5" for="check"> <i style="position: fixed" class="fa fa-whatsapp"></i> <i style="position: fixed" class="fa fa-close close"></i> </label> 
