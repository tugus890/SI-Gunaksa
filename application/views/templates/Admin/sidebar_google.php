        ...
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('admin/dashboard')  ?>">
                <div class="sidebar-brand-icon">
                   <img src="<?= base_url().'assets/images/logo.png' ?>" width="60px"height="50px" alt="">
                </div>
                <div class="sidebar-brand-text mt-3">Sispar Gunaksa</div>
            </a>
            ...
            <li class="nav-item <?php echo (strpos(current_url(), "admin/tempatwisata")||strpos(current_url(), "admin/paket_wisata") !== false) ? "active" : "" ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?= base_url('auth/ganti_pass') ?>">
                                ...
                                <a class="dropdown-item" href="<?= base_url('auth/logout_google') ?>">
